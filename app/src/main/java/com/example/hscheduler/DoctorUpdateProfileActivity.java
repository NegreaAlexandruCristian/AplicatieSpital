...
public class DoctorUpdateProfileActivity extends AppCompatActivity {
    ...
    private String nume, prenume, adresa, cnp, numarTelefon, specializare, sex = null;
    ...
    private EditText numeFamilie, prenumeUser, adresaUser, cnpUser, numarTelefonUser, specializareUser;
        ...
        displayDateOfBirth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final DatePickerDialog datePickerDialog = new DatePickerDialog(
                        DoctorUpdateProfileActivity.this,
    ...
    private boolean CheckBoxex() {
        ...
        String specializare = specializareUser.getText().toString();
        boolean ok = true;
        ...
        if (specializare.isEmpty()) {
            specializareUser.setError("Va rog alegeti una din afectiunile disponibile!");
            ok = false;
    ...
    private void UpdateUserSettings() {
        ...
        final HashMap<String, Object> profileDoctor = new HashMap<>();
        profileDoctor.put("Nume", numeFamilie.getText().toString());
        profileDoctor.put("Prenume", prenumeUser.getText().toString());
        profileDoctor.put("Specializare", specializareUser.getText().toString());
        profileDoctor.put("userID",currentUserID);
        RootRef.child("Users").child("Doctors").child(currentUserID).child("New Account?").setValue("old");
        RootRef.child("Users").child("Doctors").child(currentUserID).updateChildren(profileDoctor)

                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        RootRef.child("Users").child("Doctors").child(currentUserID).child("New Account?").setValue(null);
                        HashMap<String, Object> profileMap = new HashMap<>();
                        profileMap.put("Nume", numeFamilie.getText().toString());
                        profileMap.put("Prenume", prenumeUser.getText().toString());
                        profileMap.put("Specializare", specializareUser.getText().toString());
                        ...
                        profileMap.put("Rating","0.0");
                        profileMap.put("Studii","");
    ...
    private void initializeVariables() {
        ...
        specializareUser = findViewById(R.id.specializare);
    ...
    private void RetrieveUserProfileImage() {
        ...
        RootRef.child("Users").child("Doctors").child(currentUserID)
                ...
                filePath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        ...
                        if (task.isSuccessful()) {    // Daca totul e ok imaginea este decupata si pusa in baza de date
                            ...
                            Toast.makeText(DoctorUpdateProfileActivity.this, "Profile image has been uploaded succesfully", Toast.LENGTH_SHORT).show();

                            filePath.getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                @Override
                                public void onComplete(@NonNull Task<Uri> task) {
                                    RootRef.child("Users").child("Doctors").child(currentUserID).child("image")
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    ...
                                                    if (task.isSuccessful()) {
                                                        ...
                                                        Toast.makeText(DoctorUpdateProfileActivity.this, "Image saved in database succesfully", Toast.LENGTH_SHORT).show();
                                                        loadingBar.dismiss();
                                                        ...
                                                        Toast.makeText(DoctorUpdateProfileActivity.this, "Error" + message, Toast.LENGTH_SHORT).show();
                                                        loadingBar.dismiss();
                                                    }
                                                }
                                            });
